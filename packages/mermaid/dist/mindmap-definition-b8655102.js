import { b as yp, g as nn, l as qr, h as ei, U as mp, V as bp } from "./commonDb-ee617a3e.js";
import { B as Ep } from "./utils-865f90f3.js";
import { c as wp } from "./createText-2d261cdb.js";
import { c as Ca, g as xp } from "./_commonjsHelpers-10dfc225.js";
import { i as Tp } from "./is_dark-5f33190b.js";
...
` + he, ve.parser);
  ...
  jp(U, K), ty(K), Ep(void 0, S, H.mindmap.padding, H.mindmap.useMaxWidth);
}, ay = {
  draw: ry
}, ny = (he) => {
  let fe = "";
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++)
    he["lineColor" + ee] = he["lineColor" + ee] || he["cScaleInv" + ee], Tp(he["lineColor" + ee]) ? he["lineColor" + ee] = mp(he["lineColor" + ee], 20) : he["lineColor" + ee] = bp(he["lineColor" + ee], 20);
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++) {
    const ve = "" + (17 - 3 * ee);
    fe += `
...
//# sourceMappingURL=mindmap-definition-b8655102.js.map
