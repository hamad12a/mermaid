...
import { l as log, g as getConfig, h as setConfig, i as getSiteConfig, u as updateSiteConfig, r as reset, j as defaultConfig, s as setLogLevel, a as addDirective, k as evaluate, m as saveConfigFromInitialize, t as theme, n as setSiteConfig } from "./commonDb-59629829.js";
import { g as getErrorMessage, a as registerDiagram, r as registerLazyLoadedDiagrams, d as detectType, b as getDiagram, c as getDiagramLoader, U as UnknownDiagramError, e as extractFrontMatter, p as parseDirective, u as utils, f as directiveSanitizer, h as getStyles$1 } from "./utils-f3391f29.js";
...
const loader$h = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-484f3192.js");
...
const loader$g = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-aecbae4e.js");
...
const loader$f = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-53d9b5d4.js");
...
const loader$e = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-63fc6281.js");
...
const loader$d = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-2ef2b33e.js");
...
const loader$c = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-2b0d79c5.js");
...
const loader$b = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-391d51d0.js");
...
const loader$a = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-442cbfb5.js");
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-3cf36637.js");
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-b83e749c.js");
...
const loader$7 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-59410606.js");
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-b1171d54.js");
...
const loader$5 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-7151302d.js");
...
const loader$4 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-74abcb87.js");
...
const loader$3 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-fdc2900f.js");
...
const draw = (_text, id2, mermaidVersion, error = null) => {
  var _a;
  try {
    log.debug("Renering svg for syntax error\n");
    const svg = select("#" + id2);
    const g = svg.append("g");
    if (error && ((_a = error.message) == null ? void 0 : _a.includes("KaTeX"))) {
      const title = error.message.split(": ")[0];
      const body = error.message.replace(/[A-z]*:/, "").replace("KaTeX parse ", "");
      g.append("foreignObject").attr("height", 100).attr("width", 500).append("xhtml:div").style("font-size", "18px").style("color", "#552222").html(`<div style="font-size: 26px; margin-bottom: 8px">${title}</div><div>${body}</div>`);
      svg.attr("height", 100);
      svg.attr("width", 500);
    } else {
...
const loader$2 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-275e75fc.js");
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-8f9b32e5.js");
...
const loader = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-e15aa626.js");
...
const render = async function(id2, text, svgContainingElement) {
  ...
  try {
    ...
    errorRenderer.draw(text, id2, version, e);
    throw e;
  }
...
//# sourceMappingURL=mermaidAPI-2330821b.js.map
