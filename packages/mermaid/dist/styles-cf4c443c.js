import { i as isPlainObject, G as Graph } from "./layout-f416439d.js";
import { l as log, m as evaluate, g as getConfig, f as common, h as select } from "./commonDb-2573ecd8.js";
import { f as flowDb } from "./flowDb-cdd2a1cd.js";
import { k as isFunction, z as getStylesFromArray, A as interpolateToCurve, y as curveLinear, u as utils$1, B as setupGraphViewbox } from "./utils-f8ca1ed8.js";
import { r as render$1 } from "./index-e7220290.js";
...
const addVertices = function(vert, g, svgId, root, doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    const labelText = vertexText.replace(
      /\$\$(.*)\$\$/g,
...
const draw = async function(text2, id, _version, diagObj) {
  ...
  await render$1(element, g, ["point", "circle", "cross"], "flowchart", id);
  utils$1.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
...
//# sourceMappingURL=styles-cf4c443c.js.map
