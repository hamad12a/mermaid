import { p as parser$1, f as flowDb } from "./flowDb-cdd2a1cd.js";
import { h as has, u as uniqueId, r as range, p as pick, l as layout, d as defaults, f as forEach, G as Graph } from "./layout-f416439d.js";
import { h as select, m as evaluate, g as getConfig, f as common, l as log } from "./commonDb-2573ecd8.js";
import { a as applyStyle, b as addHtmlLabel, i as isSubgraph, c as applyTransition, e as edgeToId, d as applyClass, k as katex, f as flowRendererV2, g as flowStyles } from "./styles-cf4c443c.js";
import { l as line } from "./line-92608025.js";
import { y as curveLinear, z as getStylesFromArray, A as interpolateToCurve, B as setupGraphViewbox } from "./utils-f8ca1ed8.js";
import { s as selectAll } from "./selectAll-32e43720.js";
...
const addVertices = function(vert, g, svgId, root, _doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    if (evaluate(getConfig().flowchart.htmlLabels)) {
      const node = {
        label: vertexText.replace(/fa[blrs]?:fa-[\w-]+/g, (s) => `<i class='${s.replace(":", " ")}'></i>`).replace(
          /\$\$(.*)\$\$/g,
          (r, c) => katex.renderToString(c, { throwOnError: true, displayMode: true, output: "mathml" }).replace(/\n/g, " ").replace(/<annotation.*<\/annotation>/g, "")
        )
      };
  ...
  edges.forEach(function(edge) {
    ...
    if (edge.text === void 0) {
      ...
      if (evaluate(getConfig().flowchart.htmlLabels)) {
        ...
        edgeData.label = `<span id="L-${linkId}" class="edgeLabel L-${linkNameStart}' L-${linkNameEnd}" style="${edgeData.labelStyle}">${edge.text.replace(/fa[blrs]?:fa-[\w-]+/g, (s) => `<i class='${s.replace(":", " ")}'></i>`).replace(
          /\$\$(.*)\$\$/g,
          (r, c) => katex.renderToString(c, { throwOnError: true, displayMode: true, output: "mathml" }).replace(/\n/g, " ").replace(/<annotation.*<\/annotation>/g, "")
        )}</span>`;
      } else {
...
//# sourceMappingURL=flowDiagram-408ab566.js.map
